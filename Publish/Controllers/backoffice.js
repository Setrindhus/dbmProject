...
app.get('/backoffice/Categoria/inserir/:id',function(req,res) {
    res.render('form',{
properties: function() {
    var array = [];
    rows.forEach(element => {
...
app.get('/backoffice/Marca/inserir/:id',function(req,res) {
    res.render('form',{
properties: function() {
    var array = [];
    rows.forEach(element => {
...
app.get('/backoffice/Venda/inserir/:id',function(req,res) {
    res.render('form',{
properties: function() {
    var array = [];
    rows.forEach(element => {
